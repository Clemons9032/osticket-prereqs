...
This project is a tutorial meant to setup and install a guide for osTicket ticketing system.It'll be built in Microsoft Azure for project ease and accessibility. It'll also be accompanied with a video highlighting the install process. 
...
<details><summary>See screenshot</summary>
<img src="images/osTicket-Step.2.8.png" >
